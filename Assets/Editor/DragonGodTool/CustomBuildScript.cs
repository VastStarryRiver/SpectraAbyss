...
public class CustomBuildScript
{
    ...
    [MenuItem("GodDragonTool/打包流程/iOS/一键导出所有热更新资源", false, -3)]
    public static void OneKeyExportAllAssets_iOS()
    {
        ...
        ExportAddressables.BuildAddressables_iOS();

        CreateCatalogueFile();
    }

    [MenuItem("GodDragonTool/打包流程/iOS/导出XCode工程", false, -2)]
    public static void PackageProject_iOS()
    {
        PackageProject(BuildTarget.iOS, "");
    }

    [MenuItem("GodDragonTool/打包流程/macOS/一键导出所有热更新资源", false, -1)]
    public static void OneKeyExportAllAssets_macOS()
    {
        ExportExcelTool.ExportExcelToDictionary();
        ...
        ExportAddressables.BuildAddressables_macOS();
    }
